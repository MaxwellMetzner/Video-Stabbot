...
Desktop video stabilization application with multiple stabilization engines, built with Electron.

## Description

Video Stabbot is a desktop app for stabilizing shaky video footage. It supports FFmpeg's vidstab filters for fast stabilization, OpenCV feature tracking with advanced trajectory smoothing, and RAFT deep learning optical flow for dense motion-based stabilization.

## Features

### FFmpeg Modes
- **High Quality Mode** — Maximum analysis depth and smoothing using FFmpeg vidstab
...
- **RAFT Deep Learning** (requires PyTorch) — AI-powered dense optical flow for high-quality stabilization
